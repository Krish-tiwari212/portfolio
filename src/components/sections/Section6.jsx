...
const Section6 = () => {
  ...
  return (
    <section className='mx-2 sm:mx-20 lg:mx-40 relative' id='contact'>
        ...
        <hr className='-mt-1'/>
        <TableSkeleton numCoulmns={numColumns} numRows={numRows} cl='' cd='absolute -mt-7 h-[10rem]' />
        <div className='h-[40rem] relative'>
            ...
            <h2>
                <a href="mailto:krishtiwari2122@gmail.com" className='text-[2rem] md:text-[3rem] absolute top-0 right-0 bottom-0 -mt-[6rem] left-0 flex items-center justify-center'>krishtiwari2122@gmail.com</a>
            </h2>
